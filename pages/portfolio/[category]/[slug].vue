<template>
  <div class="flex justify-center bg-white portfolio-detail">
    <div class="content-wrapper">
      ...
      <masonry-wall class="my-1" v-if="project" :items="project.images" :ssr-columns="1" :column-width="300" :gap="5">
...
watch(route, (to) => {
  project.value = portfolio.find(item => item.slug === to.params.slug)
